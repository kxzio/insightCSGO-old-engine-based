...
void ImGui::RenderFrame2(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border, float rounding)
{
        ...
        else
        {
            ...
            if (!(flags & ImGuiWindowFlags_NoBackground))
            {
                if (!(flags & ImGuiWindowFlags_ChildWindow) && !(flags & ImGuiWindowFlags_Popup) && !(flags & ImGuiWindowFlags_Tooltip)) {
					...
					//window->DrawList->AddRectFilledMultiColor(window->Pos + ImVec2(6, 6), window->Pos + ImVec2(window->Size.x - (window->Size.x / 2), 8), ImColor(88, 122, 144), ImColor(118, 93, 133), ImColor(118, 93, 133), ImColor(72, 109, 126));

					//window->DrawList->AddRectFilledMultiColor(window->Pos + ImVec2(6 + (window->Size.x / 2) - 6, 6), window->Pos + ImVec2(window->Size.x - 6, 8), ImColor(118, 93, 133), ImColor(140, 140, 120), ImColor(140, 140, 120), ImColor(118, 93, 133));
