...
namespace ImGui
{
	...
	IMGUI_API void          RenderFrame2(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f);
	...
	IMGUI_API ImGuiID GetScrollbarIDEv(ImGuiLayoutType direction);
	IMGUI_API void ScrollbarEv(ImGuiLayoutType direction);
    ...
    IMGUI_API bool          SliderBehaviorHover(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power, ImGuiSliderFlags flags, ImRect* out_grab_bb);
    ...
    template<typename T, typename SIGNED_T, typename FLOAT_T>   IMGUI_API bool  SliderBehaviorTHover(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, T* v, const T v_min, const T v_max, const char* format, float power, ImGuiSliderFlags flags, ImRect* out_grab_bb);
