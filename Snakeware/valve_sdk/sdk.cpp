...
namespace Interfaces
{
    ...
    void Initialize()
    {
		...
		auto pidoras = GetModuleHandleA("vstdlib.dll");
		...
		g_MemAlloc = *reinterpret_cast<IMemAlloc**> (GetProcAddress(GetModuleHandleA("tier0.dll" ), "g_pMemAlloc"));
		...
		g_GlobalVars = **(CGlobalVarsBase***)(Utils::PatternScan(client, "A1 ? ? ? ? 5E 8B 40 10") + 1); // by an4rhist
		...
		g_ClientState     = **reinterpret_cast<CClientState***>((*reinterpret_cast<uintptr_t**>(g_EngineClient))[12] + 0x10);
